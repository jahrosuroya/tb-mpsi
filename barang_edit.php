<?php
	...
	if(isset($_GET['brg'])) {
		$sql = "SELECT * FROM barangjasa WHERE id_brg='". $_GET['brg'] ."'";
							...
							<div class="panel panel-default" style="background-color: #605B5B; color: #ffffff;">
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="nama" class="form-control" placeholder="Nama" value="<?php echo $data['nama'] ?>" required style="background-color: #605B5B; color: #ffffff">
											<input type="hidden" name="id" class="form-control" placeholder="Nama" value="<?php echo $data['id_brg'] ?>" required style="background-color: #605B5B; color: #ffffff">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3" style="font-weight: normal">Harga</label>
										<div class="col-sm-4">
											<input type="number" name="harga" min="0" class="form-control" placeholder="Harga" value="<?php echo $data['harga'] ?>"required style="background-color: #605B5B; color: #ffffff">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-sm-3" style="font-weight: normal">Keterangan</label>
										<div class="col-sm-4">
											<textarea name="keterangan" class="form-control" placeholder="Keterangan" rows="3" required style="background-color: #605B5B; color: #ffffff"><?php echo $data['keterangan'];?></textarea>
										</div>
									</div>
								</div>

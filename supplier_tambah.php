...
<!-- top of file -->
		...
		<div id="page-wrapper" style="background-image: url(bg/bg-1.jpg); background-size: cover;">
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal" action="supplier_insert.php" method="POST" enctype="multipart/form-data">
							<div class="panel panel-default" style="background-color: #605B5B; color: #ffffff;">
								...
								<div class="panel-body">
									<div class="form-group">
										<label class="control-label col-sm-3" ="font-weighstylet: normal">Nama</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<textarea name="alamat" class="form-control" placeholder="Alamat" rows="3" required style="background-color: #605B5B; color: #ffffff"></textarea>
										</div>
									</div>
								</div>

...
<!-- top of file -->
		...
		<div id="page-wrapper" style="background-image: url(bg/bg-1.jpg); background-size: cover;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header" style="color: #ffffff; font-weight: bold; text-shadow: 1px 1px 0 #000">Data Barang Masuk</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default" style="color: #000">
							<div class="panel-heading">
								<a href="trxbarang_tambah.php" class="btn btn-success" style=" font-weight: bold; background-color: #CC7E23; border: 0.5px solid #CC7E23; border-radius: 10px">Tambah</a>
							</div>
